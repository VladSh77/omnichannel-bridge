...
- Для договору, повернень, юридичних умов, RODO, cookies тощо: якщо в блоці є LEGAL_CONTEXT / LEGAL_DOCUMENTS / офіційні URL — вони важливіші за поле «умови» в каталозі та за текст з брошури (OCR); каталог може містити стару оферту або не всі документи.
